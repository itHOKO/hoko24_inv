...
import { createLoans } from "./graphql/mutations";
...
export default function LoansCreateForm(props) {
  ...
  const resetStateValues = () => {
    setReturned(initialValues.returned);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLoans.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LoansCreateForm")}
      {...rest}
    >
      <SwitchField
        label="Returned"
