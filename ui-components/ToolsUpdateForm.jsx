...
import { getTools } from "./graphql/queries";
import { updateTools } from "./graphql/mutations";
const client = generateClient();
export default function ToolsUpdateForm(props) {
  const {
    id: idProp,
    tools: toolsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getTools.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getTools
        : toolsModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateTools.replaceAll("__typename", ""),
            variables: {
              input: {
                id: toolsRecord.id,
                ...modelFields,
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || toolsModelProp)}
